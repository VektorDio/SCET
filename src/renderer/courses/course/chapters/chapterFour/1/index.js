...
function Chapter4_1() {
  return (
    <CoursePageWrapper>
      <ChapterTitle>
        Класифікація ланцюжків. Ланцюжки першого і другого порядків.
      </ChapterTitle>
      <ChapterParagraph>
        Як вже було сказано, для розрахунку різних систем автоматичного
        управління, вони звичайно розбиваються на динамічні ланки.
      </ChapterParagraph>
      <ChapterParagraph>
        Під динамічною ланкою розуміють пристрій будь-якого фізичного вигляду і
        конструктивного виконання, але описуваного певним диференціальним
        рівнянням.
      </ChapterParagraph>
      <ChapterParagraph>
        Будь-яка САУ, якою б складною вона не була, може бути представлена у
        вигляді сукупності деяких найпростіших елементів – типових динамічних
        ланок.
      </ChapterParagraph>
      <ChapterParagraph>
      ...
      <ChapterParagraph>
        ...
        функцій включає 10, 17, 19 та 24 різновидів ланок, однак всі вони
        утворюють три великі групи: статичні (позиційні), інтегруючі (астатичні)
        і диференціюючі (форсуючі).
      </ChapterParagraph>
      <ChapterParagraph>
      ...
      <ChapterParagraph>
        ...
        Всі теоретичні (математичні) передумови даного алгоритму розглянуті в
      ...
      <ChapterParagraph>
        ...
        безінерційний (широкосмуговий) підсилювач; дільник напруги; важільне
        з'єднання; первинні перетворювачі (датчики) - потенціометричні,
        індуктивні, обертові трансформатори, тахогенератори та ін.
      </ChapterParagraph>
      <ChapterParagraph>Аперіодична ланка першого порядку</ChapterParagraph>
      ...
      <ChapterParagraph>
        ...
        характеристики якого – прямі лінії, для різних ( якоря в електродвигуні,
        витрата рідини в гідродвигуні і т.п.); резервуар з газом, рідиною (
        перед впускним отвором, у резервуарі); нагрівальна піч ( - кількість
        теплоти, що надходить в одиницю часу, ); термопара; тиристорні,
        електромагнітні підсилювачі, гідро -, пневмо-підсилювачі та ін.
      </ChapterParagraph>
      <ChapterParagraph>Ідеальна інтегруюча ланка</ChapterParagraph>
      <TaskImage src={img48} width="700px" />
      <TaskImage src={img49} width="700px" />
      <ChapterParagraph>
        Приклади: обертовий вал; гідравлічний резервуар; гідравлічний
        підсилювач; електродвигун.
      </ChapterParagraph>
      <ChapterParagraph>Ізодромна ланка першого порядку</ChapterParagraph>
      ...
      <ChapterParagraph>
        ...
        розглядається прикладена сила, а в якості вихідної - переміщення х точки
        в якій прикладена сила); при використанні операційного підсилювача
        ізодромна ланка може бути отримана за допомогою застосування RC-ланцюга
        у зворотному зв'язку.
      </ChapterParagraph>
      <ChapterParagraph>Реально інтегруюча ланка</ChapterParagraph>
      <TaskImage src={img52} width="700px" />
      <TaskImage src={img53} width="700px" />
      <ChapterParagraph>
        Приклади: операційний підсилювач у режимі інтегрування; гідравлічний
        демпфер; гіроскоп; гідравлічний двигун, виходом якого є переміщення
        поршня, а входом - тиск рідини, що подається в циліндр.
      </ChapterParagraph>
      <ChapterParagraph>Ідеальна диференціююча ланка</ChapterParagraph>
      <TaskImage src={img54} width="700px" />
      <TaskImage src={img55} width="700px" />
      <ChapterParagraph>
        Приклади: використовуються для реалізації ємності (якщо x=U,
        y=C*(dU/dt)); індуктивності (якщо x=i,y=L(di/dt)) в електричних
        ланцюгах.
      </ChapterParagraph>
      <ChapterParagraph>Реально диференціююча ланка</ChapterParagraph>
      <TaskImage src={img56} width="700px" />
      <TaskImage src={img57} width="700px" />
      <ChapterParagraph>
        Приклади: тахогенератор постійного струму (в якості вхідної величини
        розглядати кут повороту його ротора, а в якості вихідної - е.р.с. якоря
        ); операційний підсилювач у режимі диференціювання.
      </ChapterParagraph>
      <ChapterParagraph>
        Диференціююча ланка з уповільненням у принципі вже не є типовою, тому що
        її можна замінити послідовним з'єднання ідеальної диференціюючої ланки і
        аперіодичної ланки першого порядку.
      </ChapterParagraph>
      <ChapterParagraph>
        Диференціальні рівняння, що описують ланки другого порядку можна
        представити в загальному вигляді як:
      </ChapterParagraph>
      <ChapterParagraph>
        (a2 * s^2 + a1 * s + a0) * Y(s) = kX(s)
      </ChapterParagraph>
      <ChapterParagraph>
        Залежно від коренів a+-jb характеристичного рівняння (a2 * s^2 + a1 * s
        + a0) = 0 (а вони можуть бути дійсними, комплексними і уявними) ланки
        поділяються на:
        <ol>
      ...
      <ChapterParagraph>Аперіодична ланка другого порядку</ChapterParagraph>
      <TaskImage src={img58} width="700px" />
      <TaskImage src={img59} width="700px" />
      <TaskImage src={img60} width="700px" />
      <ChapterParagraph>Консервативна ланка</ChapterParagraph>
      <TaskImage src={img61} width="700px" />
      <TaskImage src={img62} width="700px" />
      <ChapterParagraph>Коливальна ланка</ChapterParagraph>

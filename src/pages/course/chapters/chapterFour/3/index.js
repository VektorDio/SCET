  ...
  return (
    <CoursePageWrapper>
      ...
      <ChapterParagraph>
        ...
        замкнутої системи за амплітудно-фазовою характеристикою розімкнутої системи.
      </ChapterParagraph>
      <ChapterParagraph>
        Критерій стійкості Найквіста має ясний фізичний зміст:
        зв'язок стаціонарних частотних властивостей розімкнутої САУ
        з нестаціонарними властивостями замкнутої САУ.
      </ChapterParagraph>
      <ChapterParagraph>
        Критерій розглядається для двох станів розімкнутої САУ (стійкої та нестійкої).
      </ChapterParagraph>
      <ChapterParagraph>
        Перший випадок.
        Якщо розімкнута САУ стійка, то для стійкості
        замкнутої системи необхідно й достатньо, щоб АФЧХ розімкнутої
        системи не охоплювала критичну точку (-1, j0) при зміні частоти від нуля до нескінченності
      </ChapterParagraph>
      <TaskImage src={img80} width={"700px"}/>
      <ChapterParagraph>
        Модуль КПФ пропорційний коефіцієнту підсилення тому,
        АФЧХ систем при збільшенні коефіцієнта підсилення
        системи, не змінюючи своєї форми, пропорційно розширюються,
        а при зменшенні коефіцієнта звужуються, тобто при збільшенні
        коефіцієнта підсилення систем, АФЧХ може змінитися так, що
        система вийде зі стійкого стану - охопить точку (-1, j0), що видно з рис. 9.9
      </ChapterParagraph>
      <ChapterParagraph>
        Другий випадок.
        Система нестійка в розімкнутому стані та має l коренів
        у правій напівплощині буде стійкою в замкнутому стані,
        якщо АФЧХ розімкнутої системи охоплює критичну точку (-1, j0) 1/2 разів у додатному
        напрямку при зміні частоти від нуля до нескінченності.
      </ChapterParagraph>
      <ChapterParagraph>
        На рис. 9.10 як приклад показані дві АФЧХ
        нестійких у розімкнутому стані систем внаслідок
        наявності правих коренів, але стійких у замкнутому стані.
      </ChapterParagraph>
      ...
      <ChapterParagraph>
        Варіант 1.
        <ol>
          <li>Знаючи передавальну функцію розімкнутої системи Wp(s),
            необхідно попередньо визначити число правих полюсів Wp(s);
          </li>
          <li>переходимо до комплексної передавальної функції Wp(jw);</li>
          <li>виділяємо дійсну та уявну частини U(w), V(w);</li>
          <li>змінюючи частоту від нуля до нескінченності будуємо
            АФЧХ (годограф Найквіста) і дивимося охоплюється критична точка (-1, j0) чи ні;</li>
      ...
      <ChapterParagraph>
        ...
        <ol>
          <li>Знаючи передавальну функцію розімкнутої системи Wp(s),
            переходимо до комплексної передавальної функції Wp(jw);
          </li>
          <li>виділяємо дійсну та уявну частини U(w), V(w);</li>
          <li>прирівнюючи до нуля уявну частину визначаємо частоту V(w) = 0 = w*;</li>
          <li>підставляємо w* у вираз для U(w) і знаходимо точку перетину АФЧХ із дійсною віссю (координата А);</li>
          <li>робимо висновок про стійкість, якщо
              <ol>
      ...
      <ChapterParagraph>
        Факту наявності стійкості САУ при їхньому аналізі недостатньо.
        Необхідно ще оцінити величину запасу стійкості, тобто ступеню
        віддалення САУ від границь стійкості. Система, що перебуває
        близько до границі стійкості, практично, при її реалізації,
        може виявитися нестійкою (причини - неточність математичного
        опису, похибки лінеаризації, неточність визначення параметрів
        САУ і їхня зміна в часі).
      </ChapterParagraph>
      <ChapterParagraph>
        Основне поширення в якості кількісної міри запасів стійкості
        одержали дві величини - запас стійкості за модулем (амплітудою)
        і запас стійкості за фазою, що випливають із критерію Найквіста.
      </ChapterParagraph>
      <ChapterParagraph>
        Запас стійкості за модулем:
      </ChapterParagraph>
      <TaskImage src={img82} width={"700px"}/>
      <ChapterParagraph>
        Запас стійкості за модулем показує в скільки разів потрібно
        збільшити модуль розімкнутої системи (коефіцієнт підсилення системи),
        щоб замкнута система прийшла до границі стійкості,
        тобто пройшла через точку (-1, j0).
      </ChapterParagraph>
      <ChapterParagraph>
        Якщо:
        <ol>
      ...
      <ChapterParagraph>
        Зазвичай запас стійкості за модулем виражається
        в децибелах. При σ = 10+-20 дБ система є «добре» стійкою і незначна зміна параметрів не може привести до втрати стійкості.
      </ChapterParagraph>
      <ChapterParagraph>
        Запас стійкості за фазою.
      </ChapterParagraph>
      <ChapterParagraph>
        Для стабільної стійкості не досить знання
        одного запасу стійкості за модулем.
        Можливі випадки, коли АФЧХ перетинає дійсну
        вісь далеко від критичної точки, тобто система
        має великий запас стійкості за модулем.
        Однак є ділянка, де АФЧХ дуже близько проходить біля точки (-1, j0) (рис. 9.16,а).
      </ChapterParagraph>
      <ChapterParagraph>
      ...
      <ChapterParagraph>
        Для визначення запасу стійкості за фазою  системи,
        що має АФЧХ, представлену на рис. 9.16,б , проведемо коло
        одиничного радіуса. Точка перетинання АФЧХ із колом одиничного
        радіуса називається частотою зрізу wзр.
      </ChapterParagraph>
      <ChapterParagraph>
        Кут φ між вектором комплексної передавальної
        функції, модуль якої дорівнює одиниці, і негативною
        дійсною віссю називається запасом стійкості за фазою.
      </ChapterParagraph>
      <ChapterParagraph>
        Зазвичай для добре стійкої системи досить мати запас φ = 20+-40°.
        При такому значенні запасу, можливі зміни параметрів
        системи не приводять до втрати її стійкості.
      </ChapterParagraph>
      <ChapterParagraph>
        Логарифмічний частотний критерій стійкості
      </ChapterParagraph>
      <ChapterParagraph>
        Про стійкість САУ, відповідно до критерію Найквіста,
        можна судити спільно по АЧХ і ФЧХ розімкнутих систем.
        При цьому як правило використовують логарифмічні характеристики,
        що становить велику зручність у силу простоти їхньої побудови.
      </ChapterParagraph>
      <ChapterParagraph>
        Для того щоб система була стійкою в замкнутому стані,
        необхідно щоб ордината  фазової  логарифмічної
        характеристики (розімкнутої системи) на частоті
        зрізу за модулем була менше 180°:
      </ChapterParagraph>
      <TaskImage src={img84} width={"700px"}/>
      <ChapterParagraph>
        На рис. 9.17 наведені ЛАХ і ЛФХ стійкої системи.
        Крім цього показане визначення запасів стійкості за амплітудою і фазою.
      </ChapterParagraph>
      <ChapterParagraph>
        Запас стійкості за модулем Lзап визначається як кількість
        децибелів, на яку необхідно збільшити підсилення системи,
        щоб система прийшла до границі стійкості.
      </ChapterParagraph>
      <ChapterParagraph>
        Запас стійкості за фазою φзап визначається як різниця між 180° та абсолютним значенням аргументу КПФ на частоті зрізу:
      </ChapterParagraph>

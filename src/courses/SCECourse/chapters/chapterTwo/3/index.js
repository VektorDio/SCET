...
function Chapter2_3() {
  return (
    <CoursePageWrapper>
      ...
      <ChapterParagraph>
        Завдяки цьому складні перетворення, пов&apos;язані з диференціюванням та
        інтегруванням функції дійсної змінної заміняються алгебраїчними
      ...
      <ChapterParagraph>
        При розв&apos;язанні більшості практичних задач користуються таблицями
        перетворень Лапласа, отриманими на підставі виразів (3.7). Деякі важливі
      ...
      <ChapterParagraph>
        ...
        Застосовуючи перетворення Лапласа до кожного члена рівняння, одержимо
        рівняння в операційній формі:
      </ChapterParagraph>
      <ChapterParagraph>TsY(s)+Y(s)=kX(s)</ChapterParagraph>
      <ChapterParagraph>
        Це рівняння є алгебраїчним, і може бути знайдене зображення
        розв&apos;язку (вихідної величини), що при нульових початкових умовах
        має вигляд:
      </ChapterParagraph>
      ...
      <ChapterParagraph>
        ...
        є розв&apos;язком диференціального рівняння. Вираз (3.9) дає можливість
        ввести основне поняття теорії автоматичного управління, а саме, поняття
        передавальної функції W(s).
      </ChapterParagraph>
      <ChapterParagraph>
        Відношення зображення вихідної величини до зображення вхідної величини
        при нульових початкових умовах називається передавальною функцією:
      </ChapterParagraph>
